...
export default function Pricing2() {
  return (
    <div className="grid items-center gap-10 mt-8 font-sans font-thin text-slate-600 justify-evenly lg:mt-0 lg:grid-cols-3 lg:gap-7 bg-gray-50">
      <div className="z-10 flex flex-col items-center h-full transition-all duration-500 bg-white rounded-none shadow-xl group hover:text-white hover:bg-sky-900">
