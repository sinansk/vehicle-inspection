...
export default function Cards() {
  return (
    <div className="grid items-center flex-auto p-5 font-sans font-thin text-gray-400 bg-gray-100 lg:grid-cols-3 gap-7 sm:p-20 xl:px-32">
      <div className="z-10 flex flex-col items-center min-h-full transition-all duration-500 bg-white rounded-none shadow-xl sm:-mt-32 hover:scale-110">
